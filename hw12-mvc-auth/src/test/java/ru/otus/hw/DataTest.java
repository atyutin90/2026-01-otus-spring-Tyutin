...
public final class DataTest {
    ...
    public static final String NEW_USER_USERNAME = "user_new";

    public static final String NEW_USER_PASSWORD = "user_new";
    ...
    public static List<Role> getDbRoles() {
        return List.of(
            new Role(1L, "USER"),
            new Role(2L, "ADMIN")
        );
    ...
    public static List<User> getDbUsers() {
        return List.of(
            new User(1L, "admin", "$2a$10$U6O4LSdtBBjbi2uHJlToNOG5VIdbH34nV/oeb5fF/NK/5o1gP9lZm",
                getDbRoles()),
            new User(2L, "user", "$2a$10$gq2NRIXcXFbo97vh93rT2OFBSKoeLPSYAisd8Y9yoPqqihUNQKdk2",
                getDbRoles().stream().filter(it -> it.getId() == 1).toList())
        );
    }
}
