...
public class BookRepositoryTest {
    ...
    void shouldReturnCorrectBooksList() {
        ...
        assertThat(actualBooks).containsExactlyElementsOf(expected);
    ...
    void shouldSaveNewBook() {
        var expected = new Book(0, NEW_BOOK_TITLE, dbAuthors.get(0),
    ...
    void shouldSaveUpdatedBook() {
        var expected = new Book(1L, NEW_BOOK_TITLE, dbAuthors.get(2),
        ...
        var returnedBook = repository.save(expected);
