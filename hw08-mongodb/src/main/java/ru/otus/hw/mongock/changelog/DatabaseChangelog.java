...
public class DatabaseChangelog {
    ...
    @ChangeSet(order = "001", id = "dropDb", author = "atyutin", runAlways = true)
    public void dropDb(MongoTemplate mongoTemplate) {
        mongoTemplate.getMongoDatabaseFactory().getMongoDatabase().drop();
    }

    @ChangeSet(order = "002", id = "insertAuthors", author = "atyutin")
    ...
    @ChangeSet(order = "003", id = "insertGenres", author = "atyutin")
    ...
    @ChangeSet(order = "004", id = "insertBooks", author = "atyutin")
    ...
    @ChangeSet(order = "005", id = "insertComments", author = "atyutin")
