...
# Приложение для хранения книг в библиотеке, использовать MongoDB как источник хранения данных и Spring Data MongoDB в качестве способа доступа к ним.
...
* интеграционное тестрование репозиториев с помощью @DataMongoTest;
